...
type ResourceTestFixtureKafka struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorKafkaCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorKafkaConfirmDestroyed -  check is destroyed in API
