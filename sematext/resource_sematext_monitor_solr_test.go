...
type ResourceTestFixtureSolr struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorSolrCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorSolrConfirmDestroyed -  check is destroyed in API
