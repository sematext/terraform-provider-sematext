...
func resourceSematextMonitorAkka() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorAkkaCreate,
		Read:   resourceSematextMonitorAkkaRead,
		Update: resourceSematextMonitorAkkaUpdate,
		Delete: resourceSematextMonitorAkkaDelete,
		Exists: resourceSematextMonitorAkkaExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorAkkaImport,
		},
...
// resourceSematextMonitorAkkaCreate TODO Doc Comment
func resourceSematextMonitorAkkaCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAkkaRead TODO Doc Comment
func resourceSematextMonitorAkkaRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAkkaUpdate TODO Doc Comment
func resourceSematextMonitorAkkaUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAkkaDelete TODO Doc Comment
func resourceSematextMonitorAkkaDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorAkkaExists TODO Doc Comment
func resourceSematextMonitorAkkaExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorAkkaImport TODO Doc Comment
func resourceSematextMonitorAkkaImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
