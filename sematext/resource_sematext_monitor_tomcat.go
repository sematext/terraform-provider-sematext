...
func resourceSematextMonitorTomcat() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorTomcatCreate,
		Read:   resourceSematextMonitorTomcatRead,
		Update: resourceSematextMonitorTomcatUpdate,
		Delete: resourceSematextMonitorTomcatDelete,
		Exists: resourceSematextMonitorTomcatExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorTomcatImport,
		},
...
// resourceSematextMonitorTomcatCreate TODO Doc Comment
func resourceSematextMonitorTomcatCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorTomcatRead TODO Doc Comment
func resourceSematextMonitorTomcatRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorTomcatUpdate TODO Doc Comment
func resourceSematextMonitorTomcatUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorTomcatDelete TODO Doc Comment
func resourceSematextMonitorTomcatDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorTomcatExists TODO Doc Comment
func resourceSematextMonitorTomcatExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorTomcatImport TODO Doc Comment
func resourceSematextMonitorTomcatImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
