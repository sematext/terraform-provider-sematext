...
// testAccSematextMonitorAWSCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorAWSConfirmDestroyed -  check is destroyed in API
