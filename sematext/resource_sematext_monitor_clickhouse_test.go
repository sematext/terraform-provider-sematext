...
type ResourceTestFixtureClickhouse struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorClickhouseCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorClickhouseConfirmDestroyed -  check is destroyed in API
