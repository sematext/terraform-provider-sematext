...
func resourceSematextMonitorSpark() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorSparkCreate,
		Read:   resourceSematextMonitorSparkRead,
		Update: resourceSematextMonitorSparkUpdate,
		Delete: resourceSematextMonitorSparkDelete,
		Exists: resourceSematextMonitorSparkExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorSparkImport,
		},
...
// resourceSematextMonitorSparkCreate TODO Doc Comment
func resourceSematextMonitorSparkCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSparkRead TODO Doc Comment
func resourceSematextMonitorSparkRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSparkUpdate TODO Doc Comment
func resourceSematextMonitorSparkUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSparkDelete TODO Doc Comment
func resourceSematextMonitorSparkDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorSparkExists TODO Doc Comment
func resourceSematextMonitorSparkExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorSparkImport TODO Doc Comment
func resourceSematextMonitorSparkImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
