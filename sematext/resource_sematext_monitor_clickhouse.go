...
func resourceSematextMonitorClickhouse() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorClickhouseCreate,
		Read:   resourceSematextMonitorClickhouseRead,
		Update: resourceSematextMonitorClickhouseUpdate,
		Delete: resourceSematextMonitorClickhouseDelete,
		Exists: resourceSematextMonitorClickhouseExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorClickhouseImport,
		},
...
// resourceSematextMonitorClickhouseCreate TODO Doc Comment
func resourceSematextMonitorClickhouseCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorClickhouseRead TODO Doc Comment
func resourceSematextMonitorClickhouseRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorClickhouseUpdate TODO Doc Comment
func resourceSematextMonitorClickhouseUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorClickhouseDelete TODO Doc Comment
func resourceSematextMonitorClickhouseDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorClickhouseExists TODO Doc Comment
func resourceSematextMonitorClickhouseExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorClickhouseImport TODO Doc Comment
func resourceSematextMonitorClickhouseImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
