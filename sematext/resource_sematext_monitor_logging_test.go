...
type ResourceTestFixtureLogging struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorLoggingCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorLoggingConfirmDestroyed -  check is destroyed in API
