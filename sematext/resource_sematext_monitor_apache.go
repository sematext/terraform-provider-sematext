...
func resourceSematextMonitorApache() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorApacheCreate,
		Read:   resourceSematextMonitorApacheRead,
		Update: resourceSematextMonitorApacheUpdate,
		Delete: resourceSematextMonitorApacheDelete,
		Exists: resourceSematextMonitorApacheExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorApacheImport,
		},
...
// resourceSematextMonitorApacheCreate TODO Doc Comment
func resourceSematextMonitorApacheCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorApacheRead TODO Doc Comment
func resourceSematextMonitorApacheRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorApacheUpdate TODO Doc Comment
func resourceSematextMonitorApacheUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorApacheDelete TODO Doc Comment
func resourceSematextMonitorApacheDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorApacheExists TODO Doc Comment
func resourceSematextMonitorApacheExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorApacheImport TODO Doc Comment
func resourceSematextMonitorApacheImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
