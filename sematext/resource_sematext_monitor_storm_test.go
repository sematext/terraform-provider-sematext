...
type ResourceTestFixtureStorm struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorStormCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorStormConfirmDestroyed -  check is destroyed in API
