...
func resourceSematextMonitorNodejs() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorNodejsCreate,
		Read:   resourceSematextMonitorNodejsRead,
		Update: resourceSematextMonitorNodejsUpdate,
		Delete: resourceSematextMonitorNodejsDelete,
		Exists: resourceSematextMonitorNodejsExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorNodejsImport,
		},
...
// resourceSematextMonitorNodejsCreate TODO Doc Comment
func resourceSematextMonitorNodejsCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNodejsRead TODO Doc Comment
func resourceSematextMonitorNodejsRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNodejsUpdate TODO Doc Comment
func resourceSematextMonitorNodejsUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNodejsDelete TODO Doc Comment
func resourceSematextMonitorNodejsDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorNodejsExists TODO Doc Comment
func resourceSematextMonitorNodejsExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorNodejsImport TODO Doc Comment
func resourceSematextMonitorNodejsImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
