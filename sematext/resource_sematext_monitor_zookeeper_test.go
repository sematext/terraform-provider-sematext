...
type ResourceTestFixtureZookeeper struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorZookeeperCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorZookeeperConfirmDestroyed -  check is destroyed in API
