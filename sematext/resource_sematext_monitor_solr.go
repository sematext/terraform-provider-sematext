...
func resourceSematextMonitorSolr() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorSolrCreate,
		Read:   resourceSematextMonitorSolrRead,
		Update: resourceSematextMonitorSolrUpdate,
		Delete: resourceSematextMonitorSolrDelete,
		Exists: resourceSematextMonitorSolrExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorSolrImport,
		},
...
// resourceSematextMonitorSolrCreate TODO Doc Comment
func resourceSematextMonitorSolrCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrRead TODO Doc Comment
func resourceSematextMonitorSolrRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrUpdate TODO Doc Comment
func resourceSematextMonitorSolrUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrDelete TODO Doc Comment
func resourceSematextMonitorSolrDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorSolrExists TODO Doc Comment
func resourceSematextMonitorSolrExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorSolrImport TODO Doc Comment
func resourceSematextMonitorSolrImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
