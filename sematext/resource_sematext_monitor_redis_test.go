...
type ResourceTestFixtureRedis struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorRedisCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorRedisConfirmDestroyed -  check is destroyed in API
