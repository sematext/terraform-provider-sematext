...
func resourceSematextMonitorHadoop() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorHadoopCreate,
		Read:   resourceSematextMonitorHadoopRead,
		Update: resourceSematextMonitorHadoopUpdate,
		Delete: resourceSematextMonitorHadoopDelete,
		Exists: resourceSematextMonitorHadoopExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorHadoopImport,
		},
...
// resourceSematextMonitorHadoopCreate TODO Doc Comment
func resourceSematextMonitorHadoopCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHadoopRead TODO Doc Comment
func resourceSematextMonitorHadoopRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHadoopUpdate TODO Doc Comment
func resourceSematextMonitorHadoopUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHadoopDelete TODO Doc Comment
func resourceSematextMonitorHadoopDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorHadoopExists TODO Doc Comment
func resourceSematextMonitorHadoopExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorHadoopImport TODO Doc Comment
func resourceSematextMonitorHadoopImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
