...
type ResourceTestFixtureYarn struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorYarnCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorYarnConfirmDestroyed -  check is destroyed in API
