...
func resourceSematextMonitorHbase() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorHbaseCreate,
		Read:   resourceSematextMonitorHbaseRead,
		Update: resourceSematextMonitorHbaseUpdate,
		Delete: resourceSematextMonitorHbaseDelete,
		Exists: resourceSematextMonitorHbaseExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorHbaseImport,
		},
...
// resourceSematextMonitorHbaseCreate TODO Doc Comment
func resourceSematextMonitorHbaseCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHbaseRead TODO Doc Comment
func resourceSematextMonitorHbaseRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHbaseUpdate TODO Doc Comment
func resourceSematextMonitorHbaseUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHbaseDelete TODO Doc Comment
func resourceSematextMonitorHbaseDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorHbaseExists TODO Doc Comment
func resourceSematextMonitorHbaseExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorHbaseImport TODO Doc Comment
func resourceSematextMonitorHbaseImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
