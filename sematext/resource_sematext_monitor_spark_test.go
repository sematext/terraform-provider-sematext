...
type ResourceTestFixtureSpark struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorSparkCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorSparkConfirmDestroyed -  check is destroyed in API
