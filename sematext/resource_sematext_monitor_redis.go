...
func resourceSematextMonitorRedis() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorRedisCreate,
		Read:   resourceSematextMonitorRedisRead,
		Update: resourceSematextMonitorRedisUpdate,
		Delete: resourceSematextMonitorRedisDelete,
		Exists: resourceSematextMonitorRedisExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorRedisImport,
		},
...
// resourceSematextMonitorRedisCreate TODO Doc Comment
func resourceSematextMonitorRedisCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorRedisRead TODO Doc Comment
func resourceSematextMonitorRedisRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorRedisUpdate TODO Doc Comment
func resourceSematextMonitorRedisUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorRedisDelete TODO Doc Comment
func resourceSematextMonitorRedisDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorRedisExists TODO Doc Comment
func resourceSematextMonitorRedisExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorRedisImport TODO Doc Comment
func resourceSematextMonitorRedisImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
