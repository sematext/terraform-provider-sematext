...
type ResourceTestFixtureDocker struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorDockerCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorDockerConfirmDestroyed -  check is destroyed in API
