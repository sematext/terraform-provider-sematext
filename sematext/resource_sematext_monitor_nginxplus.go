...
func resourceSematextMonitorNginxPlus() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorNginxPlusCreate,
		Read:   resourceSematextMonitorNginxPlusRead,
		Update: resourceSematextMonitorNginxPlusUpdate,
		Delete: resourceSematextMonitorNginxPlusDelete,
		Exists: resourceSematextMonitorNginxPlusExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorNginxPlusImport,
		},
...
// resourceSematextMonitorNginxPlusCreate TODO Doc Comment
func resourceSematextMonitorNginxPlusCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxPlusRead TODO Doc Comment
func resourceSematextMonitorNginxPlusRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxPlusUpdate TODO Doc Comment
func resourceSematextMonitorNginxPlusUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxPlusDelete TODO Doc Comment
func resourceSematextMonitorNginxPlusDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorNginxPlusExists TODO Doc Comment
func resourceSematextMonitorNginxPlusExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorNginxPlusImport TODO Doc Comment
func resourceSematextMonitorNginxPlusImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
