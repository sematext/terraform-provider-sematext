...
type ResourceTestFixtureCassandra struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorCassandraCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorCassandraConfirmDestroyed -  check is destroyed in API
