...
func resourceSematextMonitorHaproxy() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorHaproxyCreate,
		Read:   resourceSematextMonitorHaproxyRead,
		Update: resourceSematextMonitorHaproxyUpdate,
		Delete: resourceSematextMonitorHaproxyDelete,
		Exists: resourceSematextMonitorHaproxyExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorHaproxyImport,
		},
...
// resourceSematextMonitorHaproxyCreate TODO Doc Comment
func resourceSematextMonitorHaproxyCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHaproxyRead TODO Doc Comment
func resourceSematextMonitorHaproxyRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHaproxyUpdate TODO Doc Comment
func resourceSematextMonitorHaproxyUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorHaproxyDelete TODO Doc Comment
func resourceSematextMonitorHaproxyDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorHaproxyExists TODO Doc Comment
func resourceSematextMonitorHaproxyExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorHaproxyImport TODO Doc Comment
func resourceSematextMonitorHaproxyImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
