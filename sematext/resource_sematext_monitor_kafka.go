...
func resourceSematextMonitorKafka() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorKafkaCreate,
		Read:   resourceSematextMonitorKafkaRead,
		Update: resourceSematextMonitorKafkaUpdate,
		Delete: resourceSematextMonitorKafkaDelete,
		Exists: resourceSematextMonitorKafkaExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorKafkaImport,
		},
...
// resourceSematextMonitorKafkaCreate TODO Doc Comment
func resourceSematextMonitorKafkaCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorKafkaRead TODO Doc Comment
func resourceSematextMonitorKafkaRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorKafkaUpdate TODO Doc Comment
func resourceSematextMonitorKafkaUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorKafkaDelete TODO Doc Comment
func resourceSematextMonitorKafkaDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorKafkaExists TODO Doc Comment
func resourceSematextMonitorKafkaExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorKafkaImport TODO Doc Comment
func resourceSematextMonitorKafkaImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
