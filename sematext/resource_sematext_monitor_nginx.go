...
func resourceSematextMonitorNginx() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorNginxCreate,
		Read:   resourceSematextMonitorNginxRead,
		Update: resourceSematextMonitorNginxUpdate,
		Delete: resourceSematextMonitorNginxDelete,
		Exists: resourceSematextMonitorNginxExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorNginxImport,
		},
...
// resourceSematextMonitorNginxCreate TODO Doc Comment
func resourceSematextMonitorNginxCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxRead TODO Doc Comment
func resourceSematextMonitorNginxRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxUpdate TODO Doc Comment
func resourceSematextMonitorNginxUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorNginxDelete TODO Doc Comment
func resourceSematextMonitorNginxDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorNginxExists TODO Doc Comment
func resourceSematextMonitorNginxExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorNginxImport TODO Doc Comment
func resourceSematextMonitorNginxImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
