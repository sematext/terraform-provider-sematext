...
func resourceSematextMonitorMysql() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorMysqlCreate,
		Read:   resourceSematextMonitorMysqlRead,
		Update: resourceSematextMonitorMysqlUpdate,
		Delete: resourceSematextMonitorMysqlDelete,
		Exists: resourceSematextMonitorMysqlExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorMysqlImport,
		},
...
// resourceSematextMonitorMysqlCreate TODO Doc Comment
func resourceSematextMonitorMysqlCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMysqlRead TODO Doc Comment
func resourceSematextMonitorMysqlRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMysqlUpdate TODO Doc Comment
func resourceSematextMonitorMysqlUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMysqlDelete TODO Doc Comment
func resourceSematextMonitorMysqlDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorMysqlExists TODO Doc Comment
func resourceSematextMonitorMysqlExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorMysqlImport TODO Doc Comment
func resourceSematextMonitorMysqlImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
