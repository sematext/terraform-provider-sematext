...
func resourceSematextMonitorSolrCloud() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorSolrCloudCreate,
		Read:   resourceSematextMonitorSolrCloudRead,
		Update: resourceSematextMonitorSolrCloudUpdate,
		Delete: resourceSematextMonitorSolrCloudDelete,
		Exists: resourceSematextMonitorSolrCloudExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorSolrCloudImport,
		},
...
// resourceSematextMonitorSolrCloudCreate TODO Doc Comment
func resourceSematextMonitorSolrCloudCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrCloudRead TODO Doc Comment
func resourceSematextMonitorSolrCloudRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrCloudUpdate TODO Doc Comment
func resourceSematextMonitorSolrCloudUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorSolrCloudDelete TODO Doc Comment
func resourceSematextMonitorSolrCloudDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorSolrCloudExists TODO Doc Comment
func resourceSematextMonitorSolrCloudExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorSolrCloudImport TODO Doc Comment
func resourceSematextMonitorSolrCloudImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
