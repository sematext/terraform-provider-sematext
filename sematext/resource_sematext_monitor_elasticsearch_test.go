...
type ResourceTestFixtureElasticsearch struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorElasticsearchCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorElasticsearchConfirmDestroyed -  check is destroyed in API
