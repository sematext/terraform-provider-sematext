...
type ResourceTestFixtureHadoop struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorHadoopCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorHadoopConfirmDestroyed -  check is destroyed in API
