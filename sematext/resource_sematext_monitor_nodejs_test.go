...
type ResourceTestFixtureNodejs struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorNodejsCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorNodejsConfirmDestroyed -  check is destroyed in API
