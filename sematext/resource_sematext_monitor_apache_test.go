...
type ResourceTestFixtureApache struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorApacheCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorApacheConfirmDestroyed -  check is destroyed in API
