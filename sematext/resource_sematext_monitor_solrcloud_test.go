...
type ResourceTestFixtureSolrcloud struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorSolrcloudCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorSolrcloudConfirmDestroyed -  check is destroyed in API
