...
type ResourceTestFixtureHbase struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorHbaseCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorHbaseConfirmDestroyed -  check is destroyed in API
