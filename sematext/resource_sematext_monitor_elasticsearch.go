...
func resourceSematextMonitorElasticsearch() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorElasticsearchCreate,
		Read:   resourceSematextMonitorElasticsearchRead,
		Update: resourceSematextMonitorElasticsearchUpdate,
		Delete: resourceSematextMonitorElasticsearchDelete,
		Exists: resourceSematextMonitorElasticsearchExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorElasticsearchImport,
		},
...
// resourceSematextMonitorElasticsearchCreate TODO Doc Comment
func resourceSematextMonitorElasticsearchCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorElasticsearchRead TODO Doc Comment
func resourceSematextMonitorElasticsearchRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorElasticsearchUpdate TODO Doc Comment
func resourceSematextMonitorElasticsearchUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorElasticsearchDelete TODO Doc Comment
func resourceSematextMonitorElasticsearchDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorElasticsearchExists TODO Doc Comment
func resourceSematextMonitorElasticsearchExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorElasticsearchImport TODO Doc Comment
func resourceSematextMonitorElasticsearchImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
