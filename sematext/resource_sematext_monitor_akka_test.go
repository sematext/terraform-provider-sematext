...
type ResourceTestFixtureAkka struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorAkkaCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorAkkaConfirmDestroyed -  check is destroyed in API
