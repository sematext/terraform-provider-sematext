...
func resourceSematextMonitorAws() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorAwsCreate,
		Read:   resourceSematextMonitorAwsRead,
		Update: resourceSematextMonitorAwsUpdate,
		Delete: resourceSematextMonitorAwsDelete,
		Exists: resourceSematextMonitorAwsExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorAwsImport,
		},
...
// resourceSematextMonitorAwsCreate TODO Doc Comment
func resourceSematextMonitorAwsCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAwsRead TODO Doc Comment
func resourceSematextMonitorAwsRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAwsUpdate TODO Doc Comment
func resourceSematextMonitorAwsUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorAwsDelete TODO Doc Comment
func resourceSematextMonitorAwsDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorAwsExists TODO Doc Comment
func resourceSematextMonitorAwsExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorAwsImport TODO Doc Comment
func resourceSematextMonitorAwsImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
