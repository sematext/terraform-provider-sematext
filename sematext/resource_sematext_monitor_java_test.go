...
type ResourceTestFixtureJava struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorJavaCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorJavaConfirmDestroyed -  check is destroyed in API
