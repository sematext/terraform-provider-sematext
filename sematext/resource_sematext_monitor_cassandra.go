...
func resourceSematextMonitorCassandra() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorCassandraCreate,
		Read:   resourceSematextMonitorCassandraRead,
		Update: resourceSematextMonitorCassandraUpdate,
		Delete: resourceSematextMonitorCassandraDelete,
		Exists: resourceSematextMonitorCassandraExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorCassandraImport,
		},
...
// resourceSematextMonitorCassandraCreate TODO Doc Comment
func resourceSematextMonitorCassandraCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorCassandraRead TODO Doc Comment
func resourceSematextMonitorCassandraRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorCassandraUpdate TODO Doc Comment
func resourceSematextMonitorCassandraUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorCassandraDelete TODO Doc Comment
func resourceSematextMonitorCassandraDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorCassandraExists TODO Doc Comment
func resourceSematextMonitorCassandraExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorCassandraImport TODO Doc Comment
func resourceSematextMonitorCassandraImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
