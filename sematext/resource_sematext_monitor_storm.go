...
func resourceSematextMonitorStorm() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorStormCreate,
		Read:   resourceSematextMonitorStormRead,
		Update: resourceSematextMonitorStormUpdate,
		Delete: resourceSematextMonitorStormDelete,
		Exists: resourceSematextMonitorStormExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorStormImport,
		},
...
// resourceSematextMonitorStormCreate TODO Doc Comment
func resourceSematextMonitorStormCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorStormRead TODO Doc Comment
func resourceSematextMonitorStormRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorStormUpdate TODO Doc Comment
func resourceSematextMonitorStormUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorStormDelete TODO Doc Comment
func resourceSematextMonitorStormDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorStormExists TODO Doc Comment
func resourceSematextMonitorStormExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorStormImport TODO Doc Comment
func resourceSematextMonitorStormImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
