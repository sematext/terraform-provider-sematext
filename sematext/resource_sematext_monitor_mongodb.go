...
func resourceSematextMonitorMongodb() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorMongodbCreate,
		Read:   resourceSematextMonitorMongodbRead,
		Update: resourceSematextMonitorMongodbUpdate,
		Delete: resourceSematextMonitorMongodbDelete,
		Exists: resourceSematextMonitorMongodbExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorMongodbImport,
		},
...
// resourceSematextMonitorMongodbCreate TODO Doc Comment
func resourceSematextMonitorMongodbCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMongodbRead TODO Doc Comment
func resourceSematextMonitorMongodbRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMongodbUpdate TODO Doc Comment
func resourceSematextMonitorMongodbUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorMongodbDelete TODO Doc Comment
func resourceSematextMonitorMongodbDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorMongodbExists TODO Doc Comment
func resourceSematextMonitorMongodbExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorMongodbImport TODO Doc Comment
func resourceSematextMonitorMongodbImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
