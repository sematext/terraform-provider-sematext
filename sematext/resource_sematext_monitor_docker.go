...
func resourceSematextMonitorDocker() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorDockerCreate,
		Read:   resourceSematextMonitorDockerRead,
		Update: resourceSematextMonitorDockerUpdate,
		Delete: resourceSematextMonitorDockerDelete,
		Exists: resourceSematextMonitorDockerExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorDockerImport,
		},
...
// resourceSematextMonitorDockerCreate TODO Doc Comment
func resourceSematextMonitorDockerCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorDockerRead TODO Doc Comment
func resourceSematextMonitorDockerRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorDockerUpdate TODO Doc Comment
func resourceSematextMonitorDockerUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorDockerDelete TODO Doc Comment
func resourceSematextMonitorDockerDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorDockerExists TODO Doc Comment
func resourceSematextMonitorDockerExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorDockerImport TODO Doc Comment
func resourceSematextMonitorDockerImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
