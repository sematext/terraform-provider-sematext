...
type ResourceTestFixtureNginxplus struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorNginxplusCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorNginxplusConfirmDestroyed -  check is destroyed in API
