...
type ResourceTestFixtureMysql struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorMysqlCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorMysqlConfirmDestroyed -  check is destroyed in API
