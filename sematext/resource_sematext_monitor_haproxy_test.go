...
type ResourceTestFixtureHaproxy struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorHaproxyCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorHaproxyConfirmDestroyed -  check is destroyed in API
