...
type ResourceTestFixtureNginx struct {
	Name                string
	Description         string
	Plan                string
...
// testAccSematextMonitorNginxCheckConsistency checks the App ID exists in both state and API.
...
// testAccSematextMonitorNginxConfirmDestroyed -  check is destroyed in API
