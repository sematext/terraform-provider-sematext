...
func resourceSematextMonitorYarn() *schema.Resource {
	return &schema.Resource{
		Create: resourceSematextMonitorYarnCreate,
		Read:   resourceSematextMonitorYarnRead,
		Update: resourceSematextMonitorYarnUpdate,
		Delete: resourceSematextMonitorYarnDelete,
		Exists: resourceSematextMonitorYarnExists,
		Importer: &schema.ResourceImporter{
			State: resourceSematextMonitorYarnImport,
		},
...
// resourceSematextMonitorYarnCreate TODO Doc Comment
func resourceSematextMonitorYarnCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorYarnRead TODO Doc Comment
func resourceSematextMonitorYarnRead(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorYarnUpdate TODO Doc Comment
func resourceSematextMonitorYarnUpdate(d *schema.ResourceData, meta interface{}) error {
...
// resourceSematextMonitorYarnDelete TODO Doc Comment
func resourceSematextMonitorYarnDelete(d *schema.ResourceData, meta interface{}) error { // TODO Check default is respected
...
// resourceSematextMonitorYarnExists TODO Doc Comment
func resourceSematextMonitorYarnExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
// resourceSematextMonitorYarnImport TODO Doc Comment
func resourceSematextMonitorYarnImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
