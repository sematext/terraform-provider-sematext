...
func TestAccResource(t *testing.T) {
	...
	case "AWS EBS", "AWS EC2", "AWS ELB":
		...
		testcase.TestAccResourceAWS(t, "sematext_app_hadoopyarn", "Hadoop-YARN")

	default:

		testcase.TestAccResourceDefault(t, "sematext_app_hadoopyarn", "Hadoop-YARN")
