...
require (
	...
	github.com/hashicorp/terraform-provider-scaffolding-framework v0.0.0-20230519202807-3f616587fef4
...
require github.com/hashicorp/terraform-plugin-testing v1.4.0 // indirect
